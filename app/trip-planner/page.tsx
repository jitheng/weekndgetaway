  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8">
      <div className="space-y-2 mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">Bengaluru Trip Planner</h1>
        <p className="text-sm sm:text-base text-muted-foreground">
          Plan your perfect weekend getaway from Bengaluru
        </p>
      </div>
      
      {/* Quick Tips Section */}
      <section className="mb-8 md:mb-12">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">Essential Trip Tips</h2>
